const { openFile } = require('./fileManager');
...
const { _clauses, nbVariables, nb_Clauses } = openFile('uf50-0129');

// const VALUES = [true, false];
const NB_C = nb_Clauses;
const NB_V = nbVariables;
